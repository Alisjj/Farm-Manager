...
import { TrendingUp, TrendingDown, Calculator, Target, AlertCircle, Loader2 } from "lucide-react"
...
export function CostAnalysis() {
  ...
  const loadCostData = async () => {
    try {
      ...
      if (sales.length > 0) {
        const totalRevenue = sales.reduce((sum: number, sale: { totalAmount?: number; quantity?: number }) => 
          sum + (Number(sale.totalAmount) || 0), 0);
        const totalEggs = sales.reduce((sum: number, sale: { totalAmount?: number; quantity?: number }) => 
          sum + (Number(sale.quantity) || 0), 0);
  ...
  const effectiveSellingPrice = avgSellingPrice || (costData?.suggestedPrice || 0);
  ...
  const profitMargin = effectiveSellingPrice > 0 
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {costBreakdown.total > 0 ? `₦${costBreakdown.total.toFixed(2)}` : 'N/A'}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className={`text-2xl font-bold ${profitPerEgg > 0 ? 'text-chart-5' : 'text-destructive'}`}>
        ...
        <Card>
          ...
          <CardContent>
            <div className={`text-2xl font-bold ${monthlyProjection.monthlyProfit > 0 ? 'text-chart-5' : ''}`}>
            ...
            <div className="text-xs text-muted-foreground">
              {avgDailyProduction > 0 ? `${avgDailyProduction.toFixed(0)} eggs/day avg` : 'Based on 30 days'}
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="text-xs text-muted-foreground">
              {profitMargin > 15 ? 'Above industry average' : profitMargin > 0 ? 'Below target' : 'Set prices first'}
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
              ...
              <>
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="font-medium">₦{costBreakdown.feedCost.toFixed(2)}</div>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="font-medium">₦{costBreakdown.laborCost.toFixed(2)}</div>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="font-medium">₦{costBreakdown.fixedCosts.toFixed(2)}</div>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="font-medium">₦{costBreakdown.healthCosts.toFixed(2)}</div>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
                  ...
                  <div className="text-xl font-bold">₦{costBreakdown.total.toFixed(2)}</div>
                </div>
              </>
            ) : (
              <div className="text-center py-8 text-muted-foreground">
                <p>No cost data available.</p>
                <p className="text-sm mt-2">Record daily logs and set up operating costs to see breakdown.</p>
              </div>
            )}
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Suggested price based on cost + margin</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {costBreakdown.total > 0 ? (
              <>
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <div className="text-xs text-muted-foreground">Break-even + {pricingRecommendation.markup}% margin</div>
                    </div>
                    <div className="text-right space-y-1">
                      <div className="font-medium">₦{pricingRecommendation.suggested.toFixed(2)}/egg</div>
                      <div className="text-xs text-muted-foreground">
                        {pricingRecommendation.current > 0 ? `Avg sale: ₦${pricingRecommendation.current.toFixed(2)}` : 'No sales data'}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant="outline">₦{(pricingRecommendation.suggested * 12).toFixed(0)}/dozen</Badge>
                    {pricingRecommendation.current > 0 && (
                      pricingRecommendation.current >= pricingRecommendation.suggested ? (
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-sm text-muted-foreground space-y-1">
                    {profitMargin > 20 ? (
                      <>
                        <p>• Your pricing strategy is generating healthy margins</p>
                        <p>• Consider maintaining prices during high demand periods</p>
                      </>
                    ) : profitMargin > 10 ? (
                      <>
                      ...
                      <>
                        ...
                        <p>• Review pricing or look for cost reduction opportunities</p>
                      </>
                    ) : (
                      <>
              ...
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p className="text-sm mt-2">Cost data is needed to generate pricing recommendations.</p>
              </div>
            )}
          </CardContent>
        </Card>
          ...
          {avgDailyProduction > 0 ? (
            <div className="grid gap-4 md:grid-cols-3">
              <div className="space-y-2">
                ...
                <div className={`text-2xl font-bold ${profitPerEgg > 0 ? 'text-chart-5' : ''}`}>
                  ₦{(avgDailyProduction * profitPerEgg).toLocaleString(undefined, { maximumFractionDigits: 0 })}
                </div>
                <div className="text-xs text-muted-foreground">
                  {avgDailyProduction.toFixed(0)} eggs × ₦{profitPerEgg.toFixed(2)} profit
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className={`text-2xl font-bold ${profitPerEgg > 0 ? 'text-chart-5' : ''}`}>
                  ₦{(avgDailyProduction * profitPerEgg * 7).toLocaleString(undefined, { maximumFractionDigits: 0 })}
                </div>
            ...
            <div className="text-center py-8 text-muted-foreground">
              ...
              <p className="text-sm mt-2">Record daily logs to see profit projections.</p>
            </div>
          )}
        </CardContent>
      </Card>
