(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_155e58ad._.js", {
...
__turbopack_context__.s({
    ...
    "getDailyLogById": (()=>getDailyLogById),
    "getDailyLogs": (()=>getDailyLogs),
    "getFeedBatchIngredients": (()=>getFeedBatchIngredients),
    "getFeedBatches": (()=>getFeedBatches),
    "getFeedOverview": (()=>getFeedOverview),
...
async function tryRefreshToken() {
    try {
        ...
        if (token) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authEvents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authEvents"].emit("refresh");
            return true;
        }
        return false;
    } catch  {
...
function mapBackendHouse(h) {
    return {
        id: String(h.id),
        name: h.houseName || h.name || "",
        capacity: typeof h.capacity === "number" ? h.capacity : Number(h.capacity) || 0,
        currentBirds: typeof h.currentBirdCount === "number" ? h.currentBirdCount : Number(h.currentBirdCount) || 0,
        location: h.location || "",
        dateBuilt: h.dateBuilt || h.createdAt || "",
...
async function login(username, password) {
    ...
    try {
        if ("object" !== "undefined" && data?.token) {
            localStorage.setItem("fm_token", data.token);
            if (data.refreshToken) localStorage.setItem("fm_refresh", data.refreshToken);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authEvents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authEvents"].emit("login");
        }
    } catch  {
...
function logout() {
    try {
        if ("TURBOPACK compile-time truthy", 1) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authEvents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authEvents"].emit("logout");
        }
    } catch  {
    // ignore
    }
...
async function getDailyLogs(filters) {
    ...
    if (filters) {
        ...
        if (filters.end) qs.set("end", String(filters.end));
        if (filters.houseId !== undefined && filters.houseId !== null) qs.set("houseId", String(filters.houseId));
    }
    const url = `${BASE}/api/daily-logs${qs.toString() ? "?" + qs.toString() : ""}`;
    const res = await fetchWithAuth(url);
    const data = await handleResponse(res);
    return data?.data || [];
}
async function getDailyLogById(id) {
    const res = await fetchWithAuth(`${BASE}/api/daily-logs/${encodeURIComponent(id)}`);
    const data = await handleResponse(res);
    return data?.data || null;
}
async function updateDailyLog(id, payload) {
    const res = await fetchWithAuth(`${BASE}/api/daily-logs/${encodeURIComponent(id)}`, {
        method: "PUT",
        headers: new Headers({
            "Content-Type": "application/json"
...
async function getFeedBatches() {
    const res = await fetchWithAuth(`${BASE}/api/feed/batches`);
    const data = await handleResponse(res);
    return data?.data || [];
}
async function getFeedBatchIngredients(batchId) {
    const res = await fetchWithAuth(`${BASE}/api/feed/batches/${batchId}/ingredients`);
    const data = await handleResponse(res);
    return data?.data || [];
}
async function getFeedOverview() {
    try {
        const batches = await getFeedBatches();
        // Sum ingredient amounts across batches (best-effort estimate)
        let totalKg = 0;
        for (const b of batches){
            if (!b) continue;
            // treat batch as a record and check common size keys
            const rec = b;
            const candidate = rec.size ?? rec.batchSizeKg ?? rec.sizeKg ?? rec.batchSize ?? 0;
            const n = Number(candidate);
            if (!Number.isNaN(n) && n > 0) totalKg += n;
        }
        // Try to get cost summary for the current month (fallback to null)
        const now = new Date();
        const start = new Date(now.getFullYear(), now.getMonth(), 1).toISOString().slice(0, 10);
        const end = new Date(now.getFullYear(), now.getMonth() + 1, 0).toISOString().slice(0, 10);
        let monthlyCost = null;
        try {
            const cs = await getCostSummary(start, end);
            monthlyCost = cs || null;
        } catch  {
            monthlyCost = null;
        }
...
async function getCostSummary(start, end) {
    const res = await fetchWithAuth(`${BASE}/api/costs/summary?start=${encodeURIComponent(start)}&end=${encodeURIComponent(end)}`);
    const data = await handleResponse(res);
    return data?.data || null;
}
...
async function getWorkAssignments() {
...
async function generatePayroll(monthYear, payload) {
    const res = await fetchWithAuth(`${BASE}/api/labor/payroll/generate/${encodeURIComponent(monthYear)}`, {
        method: "POST",
        headers: new Headers({
            "Content-Type": "application/json"
        }),
...
"[project]/components/daily-logs.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function DailyLogs() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DailyLogs.useEffect": ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDailyLogs"])({
                ...
                "DailyLogs.useEffect": (res)=>{
                    if (!mounted) return;
                    setLogs(Array.isArray(res) ? res : []);
                }
            }["DailyLogs.useEffect"]).catch({
                "DailyLogs.useEffect": (err)=>{
                    console.error(err);
                    if (mounted) setError(err?.message || "Failed to load logs");
                }
            }["DailyLogs.useEffect"]).finally({
                "DailyLogs.useEffect": ()=>mounted && setLoading(false)
            }["DailyLogs.useEffect"]);
            return ({
                "DailyLogs.useEffect": ()=>{
                    mounted = false;
    ...
    const handleDelete = async (id)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteDailyLog"])(String(id));
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                            ...
                            fileName: "[project]/components/daily-logs.tsx",
                            lineNumber: 70,
                            columnNumber: 11
                        }, this),
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                            children: "Recent daily logs for today"
                        }, void 0, false, {
                            fileName: "[project]/components/daily-logs.tsx",
                            lineNumber: 71,
                            columnNumber: 11
...
_s(DailyLogs, "7cUBf/5kxDf7xSVzqIv9oFmaTIo=");
_c = DailyLogs;
var _c;
__turbopack_context__.k.register(_c, "DailyLogs");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: todayStats.eggsCollected
                                    }, void 0, false, {
                                        fileName: "[project]/components/dashboard-overview.tsx",
                                        lineNumber: 70,
                                        columnNumber: 13
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            "+",
                                            ((todayStats.eggsCollected - todayStats.eggsYesterday) / todayStats.eggsYesterday * 100).toFixed(1),
                                            "% from yesterday"
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/components/dashboard-overview.tsx",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            "₦",
                                            todayStats.salesAmount.toLocaleString()
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/components/dashboard-overview.tsx",
                                        lineNumber: 89,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            "+",
                                            ((todayStats.salesAmount - todayStats.salesYesterday) / todayStats.salesYesterday * 100).toFixed(1),
                                            "% from yesterday"
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/components/dashboard-overview.tsx",
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            "-",
                                            ((todayStats.costYesterday - todayStats.costPerEgg) / todayStats.costYesterday * 100).toFixed(1),
                                            "% from yesterday"
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/components/dashboard-overview.tsx",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$progress$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Progress"], {
                                        value: todayStats.activeWorkers / todayStats.totalWorkers * 100,
                                        className: "mt-2"
                                    }, void 0, false, {
                                        fileName: "[project]/components/dashboard-overview.tsx",
                                        lineNumber: 134,
...
"[project]/components/daily-entry-form.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "DailyEntryForm": (()=>DailyEntryForm)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/card.tsx [app-client] (ecmascript)");
...
function DailyEntryForm() {
    ...
    const calculateTotal = ()=>{
        const total = (Number.parseInt(eggData.gradeA) || 0) + (Number.parseInt(eggData.gradeB) || 0) + (Number.parseInt(eggData.gradeC) || 0);
        setEggData((prev)=>({
                ...prev,
                total
            }));
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        className: "text-3xl font-bold text-balance",
                        children: "Daily Entry"
                    }, void 0, false, {
                        fileName: "[project]/components/daily-entry-form.tsx",
                        lineNumber: 35,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-muted-foreground",
                        children: "Record today's production, feed usage, and observations"
                    }, void 0, false, {
                        fileName: "[project]/components/daily-entry-form.tsx",
                        lineNumber: 36,
                        columnNumber: 9
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                        ...
                                        ].map((worker, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "flex items-center justify-between p-3 border rounded-lg",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "space-y-1",
                                                        children: [
                                                            ...
                                                            worker.tasks.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "flex gap-1",
                                                                children: worker.tasks.map((task, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                                                        variant: "outline",
                                                                        className: "text-xs",
                                                                        children: task
                                                                    }, i, false, {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                        ...
                                        children: [
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "text-xs text-muted-foreground",
                                                                children: "Only 2 days of feed remaining. Consider ordering more."
                                                            }, void 0, false, {
                                                                fileName: "[project]/components/daily-entry-form.tsx",
                                                                lineNumber: 254,
                                                                columnNumber: 19
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "flex items-start gap-3 p-3 border border-chart-3/20 bg-chart-3/5 rounded-lg",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$alert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__AlertCircle$3e$__["AlertCircle"], {
                                                        className: "h-4 w-4 text-chart-3 mt-0.5"
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/daily-entry-form.tsx",
                                                        lineNumber: 261,
                                                        columnNumber: 17
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "text-xs text-muted-foreground",
                                                                children: "House B birds due for vaccination next week."
                                                            }, void 0, false, {
                                                                fileName: "[project]/components/daily-entry-form.tsx",
                                                                lineNumber: 264,
                                                                columnNumber: 19
...
_s(DailyEntryForm, "0cmbw/nyxZqBOj06MyNiAMtYEhc=");
_c = DailyEntryForm;
var _c;
__turbopack_context__.k.register(_c, "DailyEntryForm");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$daily$2d$logs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/daily-logs.tsx [app-client] (ecmascript)");
...
;
;
function LoginShell({ onAuthSuccess }) {
    _s();
    ...
    const handle = async (e)=>{
        ...
        setLoading(true);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(loginForm.username, loginForm.password);
            if (res && res.success && res.data && res.data.user) {
                const role = res.data.user.role || "staff";
                onAuthSuccess(role === "owner" ? "owner" : "staff");
            } else {
...
_s(LoginShell, "ukhP95hv+BIbahXh0z4lWwZsItk=");
_c = LoginShell;
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                children: [
                    ...
                    tab === "daily-entry" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$daily$2d$entry$2d$form$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DailyEntryForm"], {}, void 0, false, {
                        fileName: "[project]/app/page.tsx",
                        lineNumber: 85,
                        columnNumber: 35
                    }, this),
                    tab === "daily-logs" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$daily$2d$logs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DailyLogs"], {}, void 0, false, {
                        fileName: "[project]/app/page.tsx",
                        lineNumber: 86,
                        columnNumber: 34
                    }, this)
...
_s1(AuthenticatedApp, "4mzvZfpGbnJSTCkkuuaWhNeKIc4=");
_c1 = AuthenticatedApp;
function Page() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$context$2f$UserContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserProvider"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthGate, {}, void 0, false, {
            fileName: "[project]/app/page.tsx",
            lineNumber: 95,
            columnNumber: 7
        }, this)
...
function AuthGate() {
    _s2();
    const { user, loading, refresh } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$UserContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"])();
    ...
    if (!user) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(LoginShell, {
        onAuthSuccess: async ()=>{
            await refresh();
        }
    }, void 0, false, {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthenticatedApp, {}, void 0, false, {
        fileName: "[project]/app/page.tsx",
        lineNumber: 119,
        columnNumber: 10
    }, this);
}
_s2(AuthGate, "rvX8pUzObnp4h5ytwLB+Obb9gvw=", false, function() {
    return [
...
_c3 = AuthGate;
var _c, _c1, _c2, _c3;
__turbopack_context__.k.register(_c, "LoginShell");
__turbopack_context__.k.register(_c1, "AuthenticatedApp");
__turbopack_context__.k.register(_c2, "Page");
__turbopack_context__.k.register(_c3, "AuthGate");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_155e58ad._.js.map